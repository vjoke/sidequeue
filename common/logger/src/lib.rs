...
/// Define crit macro that specify sidequeue as the target
...
/// Define debug macro that specify sidequeue as the target
// TODO Remove historical crit from code base since it isn't supported in Rust Log.
#[macro_export]
macro_rules! debug {
    ($($arg:tt)+) => ({
...
/// Define  macro that specify sidequeue as the target
#[macro_export]
macro_rules! error {
    ($($arg:tt)+) => ({
        if $crate::struct_log_enabled!($crate::log::Level::Error) {
...
/// Define info macro that specify sidequeue as the target
#[macro_export]
macro_rules! info {
    ($($arg:tt)+) => ({
...
/// Define trace macro that specify sidequeue as the target
#[macro_export]
macro_rules! trace {
    ($($arg:tt)+) => ({
...
/// Define warn macro that specify sidequeue as the target
#[macro_export]
macro_rules! warn {
    ($($arg:tt)+) => ({
