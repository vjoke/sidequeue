...
pub const DEFAULT_TARGET: &str = "sg";
const RUST_LOG: &str = "RUST_LOG";

/// Logging framework for sidequeue that encapsulates a minimal dependency logger with support for
...
/// Provies the log::Log for sidequeue's synchronous logger
struct SyncLogger<W> {
...
impl<W: Writer> Log for SyncLogger<W> {
    ...
    fn log(&self, record: &Record) {
        // The following filters out everything that does not deal with sidequeue
...
/// Provides the log::Log interface for asynchronous logger
...
/// Example:
/// 2020-03-07 05:03:03 INFO common/logger/src/lib.rs Hello
